...
The solution prepared to be built on the [.NET 9 SDK](https://dotnet.microsoft.com/download/dotnet/9.0), you need to install that before it will start working for you. 
